...
const btnDemo = document.querySelector('#btn-add');
...
output.innerHTML = `<p>${formatResult('2 + 3', add(a, b))}<p>`;
...
for(const task of tasks) {
    if (task.done) comCount++;
}

// TODO: Display: "Completed: X of Y"
output.textContent = `Completed ${comCount} of ${tasks}`;
